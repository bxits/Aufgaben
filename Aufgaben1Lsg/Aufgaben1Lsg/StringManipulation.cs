...
namespace Aufgaben1Lsg
{
    class StringManipulation
    {
        public void Run()
        {
            ...
            Console.WriteLine("" + name[0] + name[5] + name[6]);
            ...
            //       sinnvoll zusammen
            Console.WriteLine(text + " by " + name);
            ...
            string[] tmpWoerter;
            tmpWoerter = tmpText.Split(' ');
            Console.WriteLine(tmpWoerter[1]);
            ...
            Console.WriteLine(tmpWoerter[0] + " \'1337\' " + tmpWoerter[1] + " " + tmpWoerter[2] + " " + tmpWoerter[3]);

            // ToDo: Geben Sie den Verzeichnispfad aus, in dem ihr Projekt liegt
            Console.WriteLine("C:\\Users\\Ge\\source\\repos\\aufgabenStringmanipulation");
            ...
            Console.WriteLine(@"Wir geben ""-Zeichen und '-Zeichen aus");
            ...
            string platzhalter = $"{begruessung}";
            ...
            Console.WriteLine(begruessung.ToLower());
            Console.WriteLine(begruessung.ToUpper());
            ...
            Console.WriteLine(code.Substring(6, 5));
            ...
            Console.WriteLine(code.Trim('.').Trim('a'));

            // ToDo: Entfernen Sie das Zeichen 's' und x am Anfang und dem Ende aus dem String code.
            Console.WriteLine(code.Trim('.').Trim('a').Trim('s').Trim('x'));
            ...
            if (text.Contains("ula"))
            {
                Console.WriteLine("Ist enthalten.");
            }
            else
            {
            ...
            //       i -> e
            string codiert = "adrriaa";
            Console.WriteLine(codiert.Replace('a', 's').Replace('d', 'u').Replace('r', 'c').Replace('i', 'e'));
        }
    }
}
